...
echo "  ../ubuntu-game-session_0.3_all.deb"
echo "  ../ubuntu-game-handheld_0.3_all.deb"
echo ""
echo "To install session only (desktop/laptop):"
echo "  sudo apt install -y ../ubuntu-game-session_0.3_all.deb"
echo ""
...
echo "  sudo apt install -y ../ubuntu-game-handheld_0.3_all.deb"
echo ""
echo "To remove:"
